...
class Simulator:
    ...
    def rectangle(self):
        ...
        cv2.rectangle(self.image, tuple(self.rect1),
                      tuple(self.rect2), (255, 0, 0), -1)
        self.rectCenter = [(self.rect1[0] + self.rect2[0]) / 2,
                           (self.rect1[1] + self.rect2[1]) / 2]
    ...
    def removeOldRect(self):
        ...
        cv2.rectangle(self.image, tuple(self.rect1),
                      tuple(self.rect2), (255, 255, 255), -1)
